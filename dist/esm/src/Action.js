...
export class Action extends Collection {
    constructor(database, values) {
        if (!(database instanceof Database))
            throw Error(formatErrorMessage("Database class must be set correctly", "Action", "Parameter", "database"));
    ...
    save(database) {
        if (!(database instanceof Database))
            throw Error(formatErrorMessage("Database class must be set correctly", "Action", "Method", "save"));
