...
import { pathResolve, file_exists, YAML_parse, createFile, JSON_stringify, YAML, formatErrorMessage, } from "./util";
...
class Database extends EventEmitter {
    constructor(path, options = {}) {
        ...
        if (typeof path != "string")
            throw Error(formatErrorMessage("The path must be of type string", "Database", "Property", "Path"));
        if (typeof options != "object")
            throw Error(formatErrorMessage("The options must be of type object", "Database", "Property", "Options"));
        this.inputPath = path;
    ...
    writeFileSync(collection) {
        return __awaiter(this, void 0, void 0, function* () {
            yield writeFileSync(this.path, this.stringify(this.style.writing_format(collection.map)));
        });
    }
    /**
    ...
    set(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((!value && value != 0) || (!key && key != 0))
                throw Error(formatErrorMessage("No key or value found", "Database", "Method", "set"));
            let collection = yield this.cache;
            this.emit(collection.has(key) ? "elementEdit" : "elementAdd", new ElementInData(key, this), value, collection.has(key) ? collection.get(key) : null);
    ...
    delete(key) {
        return __awaiter(this, void 0, void 0, function* () {
            if (key.key)
                key = key.key;
            if (!key && key != 0)
                throw Error(formatErrorMessage("No key found", "Database", "Method", "delete"));
    ...
    getByValue(value) {
        if (value.value)
            value = value.value;
        if (!value && value != 0)
            throw Error(formatErrorMessage("No key found", "Database", "Method", "get"));
    ...
    shift(key) {
        if (key.key)
            key = key.key;
        if (!key && key != 0)
            throw Error(formatErrorMessage("No key found", "Database", "Method", "shift"));
    ...
    pull(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (key.key)
                key = key.key;
            if ((!value && value != 0) || (!key && key != 0))
                throw Error(formatErrorMessage("No key or value found", "Database", "Method", "pull"));
            if (this.has({ key }) == false)
                throw Error(formatErrorMessage("There is no data to execute on it", "Database", "Method", "pull"));
    ...
    push(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (key.key)
                key = key.key;
            if ((!value && value != 0) || (!key && key != 0))
                throw Error(formatErrorMessage("No key or value found", "Database", "Method", "push"));
    ...
    type(key) {
        if (key.key)
            key = key.key;
        if (!key && key != 0)
            throw Error(formatErrorMessage("No key found", "Database", "Method", "type"));
    ...
    has(key) {
        if (key.key)
            key = key.key;
        if (!key && key != 0)
            throw Error(formatErrorMessage("No key found", "Database", "Method", "has"));
        let data_collection = this.cache;
    ...
    clear() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.writeFileSync(new Collection());
    ...
    destroy() {
        ...
        try {
            ...
            throw Error(formatErrorMessage("The data has been destroyed before!", "Database", "Method", "destroy"));
        }
    }
    /**
    ...
    math(key, operator, new_value, goToNegative) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!key && key != 0)
                throw Error(formatErrorMessage("No key found", "Database", "Method", "math"));
            if (key.goToNegative)
            ...
            if ((!new_value && new_value != 0) || (!key && key != 0) || !operator)
                throw Error(formatErrorMessage("No key or value or operator found", "Database", "Method", "math"));
    ...
    add(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (key.key)
                key = key.key;
            if ((!value && value != 0) || (!key && key != 0))
                throw Error(formatErrorMessage("No key or value found", "Database", "Method", "add"));
    ...
    multiply(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (key.key)
                key = key.key;
            if ((!value && value != 0) || (!key && key != 0))
                throw Error(formatErrorMessage("No key or value found", "Database", "Method", "multiply"));
    ...
    double(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (key.key)
                key = key.key;
            if ((!value && value != 0) || (!key && key != 0))
                throw Error(formatErrorMessage("No key or value found", "Database", "Method", "double"));
    ...
    subtract(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (key.key)
                key = key.key;
            if ((!value && value != 0) || (!key && key != 0))
                throw Error(formatErrorMessage("No key or value found", "Database", "Method", "subtract"));
            return yield this.math(key, "-", value);
        });
    }
    /**
